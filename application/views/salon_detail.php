...
foreach ($detail as $x) {
    echo " - " . $x['nama'] . $x['jenis_salon'] . " - " . " - " . $x['kabupaten'] . " - " . $x['alamat'] . " - " . $x['pengalaman'] . "<br>";
    $namasalon = $x['namasalon'];
    $nama = $x['nama'];
    $jeniskelamin = $x['jeniskelamin'];
    $jenis_salon = $x['jenis_salon'];
    $provinsi = $x['provinsi'];
...
foreach ($layanan as $x)
    echo $x['layanan'] . " - " . $x['tarif'];

echo "<br/>";
echo $jumlah_kunjungan;
?>
